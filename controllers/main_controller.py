...
from controllers.managers_controller import ManagerController
...
class MainController:
    def __init__(self):
        ...
        self.managers_controller = ManagerController(self.managers_view)
        self.projects_controller = ProjectsController(self.projects_view)

        self.dashboard_controller = DashboardController(self.dashboard_view, parent_controller=self)
        self.projects_controller = ProjectsController(self.projects_view)
    ...
    def page_managers(self):
        ...
        self.managers_controller.load_managers()
